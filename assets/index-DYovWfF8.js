...
const scaleFactor: f32 = 1000000.0; 

fn safeLength(v: vec3<f32>) -> f32 {
    let lengthSqr = dot(v, v);
    let scaledLength = sqrt(max(lengthSqr, 1e-12)) * scaleFactor;
    return scaledLength;
}
