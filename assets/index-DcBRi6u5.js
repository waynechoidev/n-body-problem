var Q=Object.defineProperty;var Z=(e,t,r)=>t in e?Q(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var u=(e,t,r)=>(Z(e,typeof t!="symbol"?t+"":t,r),r);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=r(i);fetch(i.href,o)}})();var ee=`struct VSOutput {
...
@compute @workgroup_size(256) fn computeSomething(
    ...
    const scaleFactor: f32 = 100000.0; 
    ...
    for (var i = 0u; i < numBodies; i++) {
        if (i != index) {
            ...
            let force = (G * scaleFactor * body.mass * other.mass) / distance * distance;
...
}`;class se{constructor(t){u(this,"_canvas");u(this,"_adapter");u(this,"_device");u(this,"_context");u(this,"_encoder");u(this,"_pass");u(this,"_depthTexture");this._canvas=t}get device(){return this._device}async initialize(t,r){var n,i,o;if(this._canvas.style.width=`${t}px`,this._canvas.style.height=`${r}px`,this._canvas.width=t*2,this._canvas.height=r*2,this._adapter=await((n=navigator.gpu)==null?void 0:n.requestAdapter()),this._device=await((i=this._adapter)==null?void 0:i.requestDevice()),!this._device){const s="Your device does not support WebGPU.";console.error(s);const a=document.createElement("p");a.innerHTML=s,(o=document.querySelector("body"))==null||o.prepend(a)}this._context=this._canvas.getContext("webgpu"),this._context.configure({device:this._device,format:navigator.gpu.getPreferredCanvasFormat()})}setEncoder(){if(!this._device){console.error("RenderEnv was not initialized!");return}this._encoder=this._device.createCommandEncoder({label:"encoder"})}get encoder(){return this._encoder}getGraphicsPass(){(!this._context||!this._device)&&console.error("RenderEnv was not initialized!"),this._encoder||console.error("Encoder was not created!");const t=this._context.getCurrentTexture();(!this._depthTexture||this._depthTexture.width!==t.width||this._depthTexture.height!==t.height)&&(this._depthTexture&&this._depthTexture.destroy(),this._depthTexture=this._device.createTexture({size:[t.width,t.height],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT}));const r={label:"render pass",colorAttachments:[{view:t.createView(),clearValue:[0,0,0,1],loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this._depthTexture.createView(),depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}};return this._pass=this._encoder.beginRenderPass(r),this._pass}getComputePass(){return this._encoder||console.error("Encoder was not created!"),this._encoder.beginComputePass({label:"compute pass"})}finishEncoder(){this._device||console.error("RenderEnv was not initialized!"),this._encoder||console.error("Encoder was not created!");const t=this._encoder.finish();this._device.queue.submit([t])}}class X{constructor({label:t,device:r,vertexShader:n,fragmentShader:i}){u(this,"_label");u(this,"_pipeline");this._label=t,this._pipeline=r.createRenderPipeline({label:`${t} pipeline`,layout:"auto",vertex:{module:r.createShaderModule({label:`${t} vertex shader`,code:n}),buffers:[{arrayStride:16*Float32Array.BYTES_PER_ELEMENT,attributes:[{shaderLocation:0,offset:0,format:"float32x3"},{shaderLocation:1,offset:4*Float32Array.BYTES_PER_ELEMENT,format:"float32x3"},{shaderLocation:2,offset:8*Float32Array.BYTES_PER_ELEMENT,format:"float32x3"},{shaderLocation:3,offset:12*Float32Array.BYTES_PER_ELEMENT,format:"float32x2"},{shaderLocation:4,offset:14*Float32Array.BYTES_PER_ELEMENT,format:"float32"},{shaderLocation:5,offset:15*Float32Array.BYTES_PER_ELEMENT,format:"float32"}]}]},fragment:{module:r.createShaderModule({label:`${t} fragment shader`,code:i}),targets:[{format:navigator.gpu.getPreferredCanvasFormat()}]},primitive:{topology:"triangle-list",cullMode:"back"},depthStencil:{depthWriteEnabled:!0,depthCompare:"less-equal",format:"depth24plus"}})}getBindGroupLayout(t){return this._pipeline.getBindGroupLayout(t)}use(t){t||console.error(`GPURenderPassEncoder was not passed to ${this._label} pipeline`),t.setPipeline(this._pipeline)}}const z=1e-6;let x=typeof Float32Array<"u"?Float32Array:Array;const ae=Math.PI/180;function F(e){return e*ae}function ce(){let e=new x(9);return x!=Float32Array&&(e[1]=0,e[2]=0,e[3]=0,e[5]=0,e[6]=0,e[7]=0),e[0]=1,e[4]=1,e[8]=1,e}function Y(){let e=new x(16);return x!=Float32Array&&(e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[11]=0,e[12]=0,e[13]=0,e[14]=0),e[0]=1,e[5]=1,e[10]=1,e[15]=1,e}function le(e){return e[0]=1,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=1,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[10]=1,e[11]=0,e[12]=0,e[13]=0,e[14]=0,e[15]=1,e}function ue(e,t,r){let n=Math.sin(r),i=Math.cos(r),o=t[4],s=t[5],a=t[6],c=t[7],h=t[8],d=t[9],v=t[10],p=t[11];return t!==e&&(e[0]=t[0],e[1]=t[1],e[2]=t[2],e[3]=t[3],e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15]),e[4]=o*i+h*n,e[5]=s*i+d*n,e[6]=a*i+v*n,e[7]=c*i+p*n,e[8]=h*i-o*n,e[9]=d*i-s*n,e[10]=v*i-a*n,e[11]=p*i-c*n,e}function fe(e,t,r){let n=Math.sin(r),i=Math.cos(r),o=t[0],s=t[1],a=t[2],c=t[3],h=t[8],d=t[9],v=t[10],p=t[11];return t!==e&&(e[4]=t[4],e[5]=t[5],e[6]=t[6],e[7]=t[7],e[12]=t[12],e[13]=t[13],e[14]=t[14],e[15]=t[15]),e[0]=o*i-h*n,e[1]=s*i-d*n,e[2]=a*i-v*n,e[3]=c*i-p*n,e[8]=o*n+h*i,e[9]=s*n+d*i,e[10]=a*n+v*i,e[11]=c*n+p*i,e}function de(e,t,r,n,i){const o=1/Math.tan(t/2);if(e[0]=o/r,e[1]=0,e[2]=0,e[3]=0,e[4]=0,e[5]=o,e[6]=0,e[7]=0,e[8]=0,e[9]=0,e[11]=-1,e[12]=0,e[13]=0,e[15]=0,i!=null&&i!==1/0){const s=1/(n-i);e[10]=(i+n)*s,e[14]=2*i*n*s}else e[10]=-1,e[14]=-2*n;return e}const pe=de;function ve(e,t,r,n){let i,o,s,a,c,h,d,v,p,f,b=t[0],m=t[1],g=t[2],P=n[0],T=n[1],S=n[2],C=r[0],B=r[1],M=r[2];return Math.abs(b-C)<z&&Math.abs(m-B)<z&&Math.abs(g-M)<z?le(e):(d=b-C,v=m-B,p=g-M,f=1/Math.sqrt(d*d+v*v+p*p),d*=f,v*=f,p*=f,i=T*p-S*v,o=S*d-P*p,s=P*v-T*d,f=Math.sqrt(i*i+o*o+s*s),f?(f=1/f,i*=f,o*=f,s*=f):(i=0,o=0,s=0),a=v*s-p*o,c=p*i-d*s,h=d*o-v*i,f=Math.sqrt(a*a+c*c+h*h),f?(f=1/f,a*=f,c*=f,h*=f):(a=0,c=0,h=0),e[0]=i,e[1]=a,e[2]=d,e[3]=0,e[4]=o,e[5]=c,e[6]=v,e[7]=0,e[8]=s,e[9]=h,e[10]=p,e[11]=0,e[12]=-(i*b+o*m+s*g),e[13]=-(a*b+c*m+h*g),e[14]=-(d*b+v*m+p*g),e[15]=1,e)}function E(){let e=new x(3);return x!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e}function he(e){let t=e[0],r=e[1],n=e[2];return Math.sqrt(t*t+r*r+n*n)}function l(e,t,r){let n=new x(3);return n[0]=e,n[1]=t,n[2]=r,n}function me(e,t){let r=t[0],n=t[1],i=t[2],o=r*r+n*n+i*i;return o>0&&(o=1/Math.sqrt(o)),e[0]=t[0]*o,e[1]=t[1]*o,e[2]=t[2]*o,e}function ge(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function R(e,t,r){let n=t[0],i=t[1],o=t[2],s=r[0],a=r[1],c=r[2];return e[0]=i*c-o*a,e[1]=o*s-n*c,e[2]=n*a-i*s,e}function U(e,t,r){let n=t[0],i=t[1],o=t[2],s=r[3]*n+r[7]*i+r[11]*o+r[15];return s=s||1,e[0]=(r[0]*n+r[4]*i+r[8]*o+r[12])/s,e[1]=(r[1]*n+r[5]*i+r[9]*o+r[13])/s,e[2]=(r[2]*n+r[6]*i+r[10]*o+r[14])/s,e}const xe=he;(function(){let e=E();return function(t,r,n,i,o,s){let a,c;for(r||(r=3),n||(n=0),i?c=Math.min(i*r+n,t.length):c=t.length,a=n;a<c;a+=r)e[0]=t[a],e[1]=t[a+1],e[2]=t[a+2],o(e,e,s),t[a]=e[0],t[a+1]=e[1],t[a+2]=e[2];return t}})();function _e(){let e=new x(4);return x!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0,e[3]=0),e}function be(e,t){let r=t[0],n=t[1],i=t[2],o=t[3],s=r*r+n*n+i*i+o*o;return s>0&&(s=1/Math.sqrt(s)),e[0]=r*s,e[1]=n*s,e[2]=i*s,e[3]=o*s,e}(function(){let e=_e();return function(t,r,n,i,o,s){let a,c;for(r||(r=4),n||(n=0),i?c=Math.min(i*r+n,t.length):c=t.length,a=n;a<c;a+=r)e[0]=t[a],e[1]=t[a+1],e[2]=t[a+2],e[3]=t[a+3],o(e,e,s),t[a]=e[0],t[a+1]=e[1],t[a+2]=e[2],t[a+3]=e[3];return t}})();function W(){let e=new x(4);return x!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e[3]=1,e}function ye(e,t,r){r=r*.5;let n=Math.sin(r);return e[0]=n*t[0],e[1]=n*t[1],e[2]=n*t[2],e[3]=Math.cos(r),e}function O(e,t,r,n){let i=t[0],o=t[1],s=t[2],a=t[3],c=r[0],h=r[1],d=r[2],v=r[3],p,f,b,m,g;return f=i*c+o*h+s*d+a*v,f<0&&(f=-f,c=-c,h=-h,d=-d,v=-v),1-f>z?(p=Math.acos(f),b=Math.sin(p),m=Math.sin((1-n)*p)/b,g=Math.sin(n*p)/b):(m=1-n,g=n),e[0]=m*i+g*c,e[1]=m*o+g*h,e[2]=m*s+g*d,e[3]=m*a+g*v,e}function we(e,t){let r=t[0]+t[4]+t[8],n;if(r>0)n=Math.sqrt(r+1),e[3]=.5*n,n=.5/n,e[0]=(t[5]-t[7])*n,e[1]=(t[6]-t[2])*n,e[2]=(t[1]-t[3])*n;else{let i=0;t[4]>t[0]&&(i=1),t[8]>t[i*3+i]&&(i=2);let o=(i+1)%3,s=(i+2)%3;n=Math.sqrt(t[i*3+i]-t[o*3+o]-t[s*3+s]+1),e[i]=.5*n,n=.5/n,e[3]=(t[o*3+s]-t[s*3+o])*n,e[o]=(t[o*3+i]+t[i*3+o])*n,e[s]=(t[s*3+i]+t[i*3+s])*n}return e}const k=be;(function(){let e=E(),t=l(1,0,0),r=l(0,1,0);return function(n,i,o){let s=ge(i,o);return s<-.999999?(R(e,t,i),xe(e)<1e-6&&R(e,r,i),me(e,e),ye(n,e,Math.PI),n):s>.999999?(n[0]=0,n[1]=0,n[2]=0,n[3]=1,n):(R(e,i,o),n[0]=e[0],n[1]=e[1],n[2]=e[2],n[3]=1+s,k(n,n))}})();(function(){let e=W(),t=W();return function(r,n,i,o,s,a){return O(e,n,s,a),O(t,i,o,a),O(r,e,t,2*a*(1-a)),r}})();(function(){let e=ce();return function(t,r,n,i){return e[0]=n[0],e[3]=n[1],e[6]=n[2],e[1]=i[0],e[4]=i[1],e[7]=i[2],e[2]=-r[0],e[5]=-r[1],e[8]=-r[2],k(t,we(t,e))}})();function Ee(){let e=new x(2);return x!=Float32Array&&(e[0]=0,e[1]=0),e}function _(e,t){let r=new x(2);return r[0]=e,r[1]=t,r}function Be(e,t,r){return e[0]=t[0]+r[0],e[1]=t[1]+r[1],e}(function(){let e=Ee();return function(t,r,n,i,o,s){let a,c;for(r||(r=2),n||(n=0),i?c=Math.min(i*r+n,t.length):c=t.length,a=n;a<c;a+=r)e[0]=t[a],e[1]=t[a+1],o(e,e,s),t[a]=e[0],t[a+1]=e[1];return t}})();class Me{constructor({position:t,center:r,up:n}){u(this,"_position");u(this,"_center");u(this,"_up");u(this,"_rotate");u(this,"_isMobile");u(this,"_isDragging");u(this,"_initialX");u(this,"_initialY");this._position=t,this._center=r,this._up=n,this._rotate=_(0,0),this._isDragging=!1,this._initialX=0,this._initialY=0,this._isMobile=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),this.initializeEvent()}get position(){const t=this.getViewRotationMatrix(),r=E();return U(r,this._position,t),r}get up(){const t=this.getViewRotationMatrix(),r=E();return U(r,this._up,t),r}getViewMatrix(){const t=Y(),r=this.getViewRotationMatrix(),n=E(),i=E(),o=E();return U(n,this._position,r),U(i,this._center,r),U(o,this._up,r),ve(t,n,i,o),t}initializeEvent(){const t=this._isMobile?"touchstart":"mousedown",r=this._isMobile?"touchmove":"mousemove",n=this._isMobile?"touchend":"mouseup";document.addEventListener(t,i=>{this._isDragging=!0,this._initialX=this._isMobile?i.touches[0].clientX:i.clientX,this._initialY=this._isMobile?i.touches[0].clientY:i.clientY}),document.addEventListener(r,i=>{if(this._isDragging){const o=this._isMobile?i.touches[0].clientX:i.clientX,s=this._isMobile?i.touches[0].clientY:i.clientY,a=o-this._initialX,c=s-this._initialY;this._rotate=Be(this._rotate,this._rotate,_(c/10,a/10)),this._initialX=o,this._initialY=s}}),document.addEventListener(n,()=>{this._isDragging=!1})}getViewRotationMatrix(){const t=Y();return fe(t,t,F(this._rotate[1])),ue(t,t,F(this._rotate[0])),t}}class V{static async loadImageBitmap(t){const n=await(await fetch(t)).blob();return await createImageBitmap(n,{colorSpaceConversion:"none"})}static async generateMips(t,r){let n=t;const i=[n];let o=0;for(;o<r&&(n.width>1||n.height>1);)n=await this.createNextMipLevelRgba8Unorm(n),i.push(n),o++;return i}static async createNextMipLevelRgba8Unorm(t){const r=Math.max(1,t.width/2|0),n=Math.max(1,t.height/2|0),i=document.createElement("canvas");i.width=r,i.height=n;const o=i.getContext("2d");if(!o)throw new Error("Unable to get 2D context");return o.drawImage(t,0,0,r,n),createImageBitmap(i)}}class Ue{constructor(t){u(this,"_device");u(this,"_texture");this._device=t}get view(){return this._texture||console.error("You need to initialize texture first!"),this._texture.createView({dimension:"cube"})}async initialize(t,r=0){const n=await Promise.all(t.map(V.loadImageBitmap));if(this._texture=this._device.createTexture({label:"yellow F on red",size:[n[0].width,n[0].height,n.length],mipLevelCount:r+1,format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),!this._texture){console.error("Failed to load texture");return}for(let i=0;i<6;i++)(await V.generateMips(n[i],r)).forEach((s,a)=>{this._device.queue.copyExternalImageToTexture({source:s,flipY:!1},{texture:this._texture,origin:[0,0,i],mipLevel:a},{width:s.width,height:s.height})})}}class Pe{constructor(t,r){u(this,"_label");u(this,"_device");u(this,"_vertices");u(this,"_indices");u(this,"_vertexBuffer");u(this,"_indexBuffer");this._label=r,this._device=t,this._vertices=[],this._indices=[]}initialize(){const t=[];for(let i=0;i<this._vertices.length;i++){const{position:o,velocity:s,color:a,texCoord:c,radius:h,mass:d}=this._vertices[i];t.push(...o,0,...s,0,...a,0,...c,h,d)}const r=new Float32Array(t);this._vertexBuffer=this._device.createBuffer({label:`${this._label}-vertex-buffer`,size:r.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this._device.queue.writeBuffer(this._vertexBuffer,0,r);const n=new Uint32Array(this._indices);this._indexBuffer=this._device.createBuffer({label:`${this._label}-index-buffer`,size:n.byteLength,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST}),this._device.queue.writeBuffer(this._indexBuffer,0,n)}draw(t){if(!this._vertexBuffer||!this._indexBuffer){console.error(`${this._label} mesh was not initialized!`);return}if(!t){console.error(`GPURenderPassEncoder was not passed to ${this._label} mesh`);return}t.setVertexBuffer(0,this._vertexBuffer),t.setIndexBuffer(this._indexBuffer,"uint32"),t.drawIndexed(this._indices.length)}}class Te extends Pe{constructor(t){super(t,"skybox"),this._vertices.push({position:l(-1,1,-1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._vertices.push({position:l(-1,-1,-1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._vertices.push({position:l(1,1,-1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._vertices.push({position:l(1,-1,-1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._vertices.push({position:l(-1,1,1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._vertices.push({position:l(1,1,1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._vertices.push({position:l(-1,-1,1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._vertices.push({position:l(1,-1,1),velocity:l(0,0,0),color:l(0,0,0),texCoord:_(0,0),radius:0,mass:0}),this._indices.push(0,1,2,2,1,3,2,3,5,5,3,7,5,7,4,4,7,6,4,6,0,0,6,1,4,0,5,5,0,2,1,6,3,3,6,7),this.initialize()}}class Se{constructor(t,r){u(this,"_label");u(this,"_device");u(this,"_pointBuffer");u(this,"_billboardBuffer");this._device=t,this._label=r}async initialize(t){const r=[];for(let i=0;i<t.length;++i){const{position:o,velocity:s,color:a,texCoord:c,radius:h,mass:d}=t[i];r.push(...o,0,...s,0,...a,0,...c,h,d)}const n=new Float32Array(r);this._pointBuffer=this._device.createBuffer({label:`${this._label} point vertex buffer`,size:n.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this._device.queue.writeBuffer(this._pointBuffer,0,n),this._billboardBuffer=this._device.createBuffer({label:`${this._label} billboard vertex buffer`,size:n.byteLength*6,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST})}get point(){return this._pointBuffer||console.error(`${this._label} vertex buffers should be initialized first!`),this._pointBuffer}get billboard(){return this._billboardBuffer||console.error(`${this._label} vertex buffers should be initialized first!`),this._billboardBuffer}}class H{constructor({label:t,device:r,computeShader:n}){u(this,"_label");u(this,"_pipeline");this._label=t,this._pipeline=r.createComputePipeline({label:`${t} compute pipeline`,layout:"auto",compute:{module:r.createShaderModule({label:`${t} compute shader`,code:n})}})}getBindGroupLayout(t){return this._pipeline.getBindGroupLayout(t)}use(t){t||console.error(`GPUComputePassEncoder was not passed to ${this._label} pipeline`),t.setPipeline(this._pipeline)}}class Ce{constructor(t){u(this,"_device");u(this,"_texture");this._device=t}get view(){return this._texture||console.error("You need to initialize texture first!"),this._texture.createView()}async initialize(t,r=0){const n=await V.loadImageBitmap(t),i=await V.generateMips(n,r);if(this._texture=this._device.createTexture({label:"yellow F on red",size:[i[0].width,i[0].height],mipLevelCount:i.length,format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST|GPUTextureUsage.RENDER_ATTACHMENT}),!this._texture){console.error("Failed to load texture");return}i.forEach((o,s)=>{this._device.queue.copyExternalImageToTexture({source:o,flipY:!1},{texture:this._texture,mipLevel:s},{width:o.width,height:o.height})})}}const ze=()=>{const e=navigator.userAgent;return!!(/windows phone/i.test(e)||/android/i.test(e)||/iPad|iPhone|iPod/.test(e))},A=window.innerWidth,L=window.innerHeight;async function Ve(){ze()&&alert("On mobile devices, we will not support this feature due to potential precision issues with the computations.");const e=new se(document.querySelector("canvas"));if(await e.initialize(A,L),!e.device)return;const t="",r=new Ue(e.device);await r.initialize([t+"cubemap/px.jpg",t+"cubemap/nx.jpg",t+"cubemap/py.jpg",t+"cubemap/ny.jpg",t+"cubemap/pz.jpg",t+"cubemap/nz.jpg"]);const n=new Ce(e.device);await n.initialize(t+"star.png");const i=e.device.createSampler({magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}),o=new H({label:"movement",device:e.device,computeShader:te}),s=new H({label:"billboard",device:e.device,computeShader:ee}),a=new X({label:"main",device:e.device,vertexShader:ne,fragmentShader:ie}),c=new X({label:"bg",device:e.device,vertexShader:re,fragmentShader:oe}),h=new Te(e.device),d=3,v=[];v.push({position:l(0,0,0),velocity:l(0,0,0),color:l(.8,.2,.2),texCoord:_(0,0),radius:.2,mass:.05}),v.push({position:l(4,-1,-2),velocity:l(0,0,0),color:l(.2,.8,.8),texCoord:_(0,0),radius:.1,mass:.02}),v.push({position:l(-2,4,-4),velocity:l(0,0,0),color:l(.8,.8,.2),texCoord:_(0,0),radius:.3,mass:.03});const p=new Se(e.device,"object");await p.initialize(v);const f=e.device.createBuffer({label:"matrix uniforms",size:32*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),b=e.device.createBuffer({label:"frag uniforms",size:3*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),m=e.device.createBuffer({label:"camera uniforms",size:8*Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),g=e.device.createBuffer({label:"time uniform buffer",size:Float32Array.BYTES_PER_ELEMENT,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),P=e.device.createBindGroup({label:"bind group for object",layout:a.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:f}},{binding:1,resource:{buffer:b}},{binding:2,resource:n.view},{binding:3,resource:i}]}),T=e.device.createBindGroup({label:"compute movement bind group",layout:o.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:p.point}},{binding:1,resource:{buffer:g}}]}),S=e.device.createBindGroup({label:"compute billboard bind group",layout:s.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:p.point}},{binding:1,resource:{buffer:p.billboard}},{binding:2,resource:{buffer:m}}]}),C=e.device.createBindGroup({label:"bind group for object",layout:c.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:f}},{binding:1,resource:i},{binding:2,resource:r.view}]}),B=new Me({position:l(0,0,2.5),center:l(0,0,0),up:l(0,1,0)}),M=Y();pe(M,F(45),A/L,.1,100);let N=0;async function I(){var q,D,$,j;const G=performance.now(),J=G-N;N=G,(q=e.device)==null||q.queue.writeBuffer(g,0,new Float32Array([J])),(D=e.device)==null||D.queue.writeBuffer(b,0,new Float32Array([G*.001,A,L]));const K=B.getViewMatrix();($=e.device)==null||$.queue.writeBuffer(f,0,new Float32Array([...K,...M])),(j=e.device)==null||j.queue.writeBuffer(m,0,new Float32Array([...B.position,0,...B.up,0])),e.setEncoder();const w=e.getComputePass();o.use(w),w.setBindGroup(0,T),w.dispatchWorkgroups(1,1),s.use(w),w.setBindGroup(0,S),w.dispatchWorkgroups(1,1),w.end();const y=e.getGraphicsPass();c.use(y),y==null||y.setBindGroup(0,C),h.draw(y),a.use(y),y==null||y.setBindGroup(0,P),y.setVertexBuffer(0,p.billboard),y.draw(d*6),y.end(),e.finishEncoder(),requestAnimationFrame(I)}I()}Ve();
